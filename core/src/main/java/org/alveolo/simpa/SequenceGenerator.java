 ...
 * generator element is specified for the {@link GeneratedValue} annotation.
 * A sequence generator may be specified on the entity class or on the
 * primary key field or property. The scope of the generator name is global
...
public @interface SequenceGenerator {
	/**
	 * (Required) A unique generator name that can be referenced by one or
	 * more classes to be the generator for primary key values.
	 */
	String name();

	/**
	 * (Optional) The name of the database sequence object from which to
